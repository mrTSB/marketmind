      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <MarketDemographics {...marketData.demographics} />
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <PainPoints
              pain_points={marketData?.pain_points?.pain_points ?? []}
              market_impact={marketData?.pain_points?.market_impact ?? "No market impact data available"}
              opportunity_size={marketData?.pain_points?.opportunity_size ?? "No opportunity size data available"}
              priority_level={marketData?.pain_points?.priority_level ?? "medium"}
            />
            <RegulatoryEnvironment
              current_regulations={marketData?.regulatory_environment?.current_regulations ?? []}
              pending_regulations={marketData?.regulatory_environment?.pending_regulations ?? []}
              compliance_requirements={marketData?.regulatory_environment?.compliance_requirements ?? []}
              regulatory_bodies={marketData?.regulatory_environment?.regulatory_bodies ?? []}
              potential_risks={marketData?.regulatory_environment?.potential_risks ?? []}
            />
          </div>
        </section>
      </div>
